...
{
    public abstract class Followers : TwitterJob
    {
        internal Followers(Credentials credentials, EventHandler<JobCompleteArgs> completionDelegate, string cursor, long count)
